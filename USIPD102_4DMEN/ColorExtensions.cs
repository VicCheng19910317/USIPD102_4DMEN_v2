...
namespace USIPD102_4DMEN
{
    ...
    {
        public static void ChangePrimaryColor(this PaletteHelper paletteHelper, System.Windows.Media.Color color)
        {
        ...
        public static void ChangeDarkMode(this PaletteHelper paletteHelper, bool isDark = false)
        {
            ITheme theme = paletteHelper.GetTheme();
