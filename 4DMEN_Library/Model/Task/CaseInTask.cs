        ...
        protected void RunStep()
        {
            switch (Step)
            {
                ...
                case 2: ///判斷換Tray是否完成
                    ...
                    break;
                case 3: ///手臂取料
                    if (!DoArmsActionErrorWithoutWait(() => MainPresenter.CaseInArms().Pick(MainPresenter.SystemParam().Flow.CaseInGlue), MainPresenter.CaseInArms(), "入料手臂取料錯誤，請重新將手臂回Home再行後續動作"))
                    {
